...
const Signup = () => {
  ...
  const speakStep = (step) => {
    const messages = [
      ["Please enter your username.", "వినియోగదారి పేరు ఇవ్వండి."],
      ["Please enter your email.", "ఇమెయిల్ ఇవ్వండి."],
      ["Please enter your password.", "పాస్‌వర్డ్ ఇవ్వండి."],
      ["Please confirm your password.", "పాస్‌వర్డ్‌ను నిర్ధారించండి."],
      ["Please select your role.", "మీ పాత్రను ఎంచుకోండి."],
    ];
  ...
  const handleChange = (e) => {
    ...
    typingTimeout.current = setTimeout(() => {
      ...
      if (name === "confirmPassword" && formData.password !== value) {
        ...
        speak("పాస్‌వర్డ్‌లు సరిపోలలేదు.", "te-IN");
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://finalproject-2-mdww.onrender.com/api/auth/signup", formData);
